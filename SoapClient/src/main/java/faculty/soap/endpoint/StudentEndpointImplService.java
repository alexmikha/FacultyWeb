 ...
 * 
 */
@WebServiceClient(name = "StudentEndpointImplService", targetNamespace = "http://endpoint.soap.faculty/", wsdlLocation = "http://localhost:9999/soap/test?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTENDPOINTIMPLSERVICE_QNAME = new QName("http://endpoint.soap.faculty/", "StudentEndpointImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/soap/test?wsdl");
    ...
    public StudentEndpoint getStudentEndpointImplPort() {
        return super.getPort(new QName("http://endpoint.soap.faculty/", "StudentEndpointImplPort"), StudentEndpoint.class);
    }
    ...
    public StudentEndpoint getStudentEndpointImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpoint.soap.faculty/", "StudentEndpointImplPort"), StudentEndpoint.class, features);
    }
